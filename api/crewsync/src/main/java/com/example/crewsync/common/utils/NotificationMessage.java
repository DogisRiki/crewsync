...
public class NotificationMessage {
    ...
    public boolean isInfo() {
        return messageLevel == MESSAGE_LEVEL_INFO;
    }

    public boolean isSuccess() {
        return messageLevel == MESSAGE_LEVEL_SUCCESS;
    }

    public boolean isWarning() {
        return messageLevel == MESSAGE_LEVEL_WARNING;
    }

    public boolean isError() {
        return messageLevel == MESSAGE_LEVEL_ERROR;
    }
